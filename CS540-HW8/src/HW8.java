...
/**
 * Main class that acts as a launcher for your classification algorithm. !! DO
 * NOT MODIFY !!
 *
 */
...
public class HW8 {
	 ...
	 * classification algorithm and prints results to the console.
	 */
	public static void main(String[] args) throws IOException {
		...
		if (res == null) {
			System.out.println(
					"Please implement the classification method to return a non-null result.");
			return;
		}
